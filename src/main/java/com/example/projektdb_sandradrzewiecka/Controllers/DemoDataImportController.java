...
@Profile("demo")
@RestController
public class DemoDataImportController implements CommandLineRunner {
    @Autowired
    ...
    public void run(String... args) throws Exception {
        ...
        List<MagazynP> magazynP = csvService.readCSVp("DemoMagazynp.csv");
        System.out.println("File parsed");
        ...
        List<MagazynW> magazynW = csvService.readCSVw("DemoMagazynw.csv");
        System.out.println("File parsed");
        ...
        System.out.println("Stworzenie zestawienia dla magazynu P: localhost:8080/zadanie1");
        System.out.println("Posortowanie zestawienia: ");
        System.out.println("localhost:8080/zadanie1/sortByNrKarty");
        System.out.println("localhost:8080/zadanie1/sortByKod");
        System.out.println("localhost:8080/zadanie1/sortByFirma\n");
